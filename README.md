...
**WARNING**: The future tutorial that will be written **soon** SHOULD be considered a tutorial that is geared **MAINLY** for developers who use the iOS Simulator on an occasional or constant basis, and who delibrately wish to install custom tweaks, libraries, etc. on their iOS Simulators (which Xcode has already bundled already in!), and is not meant for the fate of heart** (so average end users). If you **do not know what simject is, then please close this page immediately (to avoid simple obsession over it)!!!** It can potentially damage the files you have installed, as well as Xcode, the iOS Simulator, and other applications accompanyining it as well. There are reasons to things in life you just shouldn't use if you are a beginner to something you don't know about, and this is one of them.
