...
The future tutorial that will be written soon should be considered a tutorial that is a much more complete version than this one, and this one for the time being right now should be geared for many developers out there in the community who use the iOS Simulator, and Xcode - as well as other various development-related tools - on a day-to-day and occasional basis, and only to those **who have the delibrate intention** to install any third-part/custom tweaks, libraries, preference bundles, etc. on their iOS Simulators and that even Xcode that require Cydia Substrate to test this is on and it should **not** be used for the fate of heart (meaning that it should not be used from the typical end user). If you do not know what this is **//at all//**, **please close this page to avoid simple obsession over it right now, as it can potentially damage your simple installation of Xcode, and the iOS Simulator; as well as other Xcode-related development tools installed locally on your machine**. There are reasons for why you just should not use such things in life, and why you should just not mess around with them, and hopefully you can now see why that this is one of them.
