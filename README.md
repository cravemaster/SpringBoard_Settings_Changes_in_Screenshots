...
So this page was created for the purposes of showing developers out there that it **is** possible to invoke the internal SpringBoard prototype settings menu, and so that they can look into **this** instead of going to <a href="https://www.twitter.com/hamzasood
">@hamzasood</a>'s Twitter profile to check the any new internal SpringBoard prototype settings that *he* has Tweeted himself - it is also a neat alternative, and proves I can put a bit of hope into your heart that I am also a developer too - and not one who just brags about being one either. On the topic of developers, it's worth noting that I am not your average developer. I would consider myself another Andy Wiik (but he has things on the BigBoss Cydia repository that I have had removed due to "harassment" and belligerence towards other major developers in the jailbreak community).

The future tutorial that will be written soon should be considered a tutorial that is a much more complete version than this one, and this one (for right now, that is) should be only geared for developers out there in the jailbreaking and iOS hacking communities and that share strong interest in hacking the iOS Simulator - as well as other development-related tools - on a day-to-day basis: basically this project is only meant for developers out there of whom have the **delibrate intention** to install any third-party/custom tweaks, libraries, preference bundles, and other software on their iOS Simulators which would require Cydia Substrate to test this is on and it should **not** be used for the fate of heart (meaning that it **should not** be used from the typical end user). If you do not know what this is **//at all//**, stop, think, and please close this page to avoid obsession over it, as you are very likely to **potentionally damage your installation of Xcode, and the iOS Simulator that is also bundled with it to test your accompanying software with; as well as your other bundled development tools that Xcode has installed on your machine**. There are reasons for why you just should not use such things in life, and why you should just not mess around with them, and hopefully you can now see why this is one of them.
...
In conclusion: this is something that I recommend **mainly for developers**, however the end user is absolutely welcome to try if they'd like. In this such example, it only has ever been tested on so many iOS Simulator versions out there; that of which being iOS 10.0 Simulator, iOS 10.1 Simulator and iOS 10.3 Simulator, along with only added x86_64 support. You can find the screenshots in **/iOS 10.3/YOUR_DEVICE/XX_INCH_SCREEN/PARTXX_EXAMPLE_SCREENSHOT_MENU_PARTXX.png**. Here's a good exmple of what is trying to be said here: **<a href="https://github.com/cravemaster/SpringBoard_Settings_Changes_in_Screenshots/blob/master/iOS%2010.3/iPhone/4%20in%20screen/p1_main_root_menu_p1.png
">/iOS 10.3/iPhone/4 in screen/p1_main_root_menu_p1.png</a>**.
